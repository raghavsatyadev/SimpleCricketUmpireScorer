    ...
    ConstraintLayout(
      ...
      Button(
        ...
        Text(
          text =
            if (isFirstInningComplete) {
              stringResource(R.string.end_match)
            } else {
              stringResource(R.string.end_inning)
            }
        )
      }
      ...
      if (isFirstInningComplete) {
        Text(
          text = stringResource(R.string.required_runs_balls, record.requiredRunsBalls),
      ...
      Text(
        text = stringResource(R.string.crr, record.currentCRR),
        style = MaterialTheme.typography.titleLarge,
        modifier =
      ...
      if (isFirstInningComplete) {
        Text(
          text = stringResource(R.string.rrr, record.currentRRR),
          style = MaterialTheme.typography.titleLarge,
          modifier =
      ...
      if (!isFirstInningComplete) {
        IconButton(
          ...
          Icon(
            ...
            contentDescription = stringResource(R.string.edit_total_overs),
          )
        }
      }
      ...
      FloatingActionButton(
        ...
        Icon(
          ...
          contentDescription = stringResource(R.string.add_wicket),
        )
      }
      Text(
        modifier =
      ...
      FloatingActionButton(
        ...
        Icon(
          ...
          contentDescription = stringResource(R.string.minus_wicket),
        )
      }
      ...
      FloatingActionButton(
        ...
        Icon(
          painter = painterResource(R.drawable.ic_minus),
          contentDescription = stringResource(R.string.minus_run),
        )
      }
      FloatingActionButton(
        ...
        Icon(
          painter = painterResource(R.drawable.ic_minus),
          contentDescription = stringResource(R.string.minus_ball),
        )
      }
      Text(
        modifier =
      ...
      FloatingActionButton(
        ...
        Icon(
          ...
          painter = painterResource(R.drawable.ic_add),
          contentDescription = stringResource(R.string.add_run),
        )
      }
      FloatingActionButton(
        ...
        Icon(
          modifier = Modifier.size(50.dp),
          painter = painterResource(R.drawable.ic_add),
          contentDescription = stringResource(R.string.add_ball),
        )
      }
    }
  }
...
private fun ResetDialog(
  ...
  AlertDialog(
    ...
    title = { Text(stringResource(R.string.reset_match)) },
    text = {
      Text(
        if (record.isFirstInningComplete) {
          stringResource(R.string.reset_full_match_message)
        } else {
          stringResource(R.string.reset_inning_message)
        }
      )
    },
    confirmButton = {
      Row {
        TextButton(
          ...
          Text(stringResource(R.string.reset_inning))
        }
        if (record.isFirstInningComplete) {
          TextButton(
            onClick = {
            ...
            Text(stringResource(R.string.reset_full))
          }
        }
      }
    },
...
private fun EditOversDialog(
  ...
  AlertDialog(
    onDismissRequest = dismissDialog,
    title = { Text(stringResource(R.string.edit_total_overs)) },
    text = {
      TextField(
        value = editedOvers,
