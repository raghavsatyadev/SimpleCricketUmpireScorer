...
/** Utility class to handle Firebase Authentication operations with Google Sign-In. */
class FirebaseAuthUtil private constructor(private val firebaseApp: FirebaseApp) {
  companion object {
    @Volatile private var instance: FirebaseAuthUtil? = null
   ...
   * @return A [Pair] containing the signed-in [User] and a [CustomError] if any occurred.
   */
